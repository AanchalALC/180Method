/* ============================================================================
   TEAM
   Names / pronouns / roles are confirmed from the live site.
   Bios are PLACEHOLDERS — audit item T1. The 180 team owes 40–60 words +
   credentials + an 800x1000 portrait for each person.
   Anything still marked `bioPending: true` renders a subtle "bio coming soon"
   state instead of fake copy.
   ========================================================================== */
